...
function InstructorSideBar({ current, onSelect, onLogout }) {
  const menuItems = [
    { key: "dashboard", label: "Dashboard", icon: "bx bxs-dashboard" },
    { key: "courses", label: "My Courses", icon: "bx bxs-book" },
    { key: "students", label: "My Students", icon: "bx bxs-group" },
  ];
    ...
    <div className="bg-white shadow-lg flex flex-col p-4 px-10 h-full justify-between">
      <div>
        ...
        >
          ...
          <span className="text-lg font-semibold text-blue-900">LMS Instructor</span>
        </div>
